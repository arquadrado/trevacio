  ...
  <div class="content-wrapper">
    <div class="reading-session">
      <div class="modal-header">
        ...
        <br>
        <button @click="setContent('book')">
          <span class="clickable-text">Book</span>
        </button>
        <button class="" v-if="hasHistory" @click="back">
          <span class="clickable-text">Back</span>
        </button>
        <button v-if="!adding" class="" @click="deleteSession">
          <span class="clickable-text">Delete</span>
        </button>
        <button @click="setContent('home')">
      ...
      <div class="modal-body">
        ...
        <div class="session" v-else>
          <span>
            <strong>Starting page:</strong> {{ selectedSession.start }}</span><br>
          <span>
            <strong>Ending page:</strong> {{ selectedSession.end }}</span><br>
          <span>
            <strong>Pages read:</strong> {{ selectedSession.end - selectedSession.start }}</span><br>
      ...
      <div class="modal-footer">
        <button v-if="!adding" class="" @click="setSelectedReadingSession(null)">
